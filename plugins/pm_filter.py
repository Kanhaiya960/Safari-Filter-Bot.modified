...
async def pm_text(bot, message):
    ...
    if await db.get_setting("PM_FILTER", default=PM_FILTER) or await db.has_premium_access(message.from_user.id):
        ...
        await message.reply_text("<b>ɪғ ʏᴏᴜ ᴡᴀɴᴛ ᴛᴏ ɢᴇᴛ ᴍᴏᴠɪᴇs ғʀᴏᴍ ᴛʜɪs ʙᴏᴛ ᴛʜᴇɴ ʏᴏᴜ ʜᴀᴠᴇ ᴛᴏ 𝗕𝗨𝗬 𝗣𝗥𝗘𝗠𝗜𝗨𝗠 𝗦𝗨𝗕𝗦𝗖𝗥𝗜𝗣𝗧𝗜𝗢𝗡 ғᴏʀ ᴛʜɪs ʙᴏᴛ.\n\nयदि आप इस बॉट से फिल्में प्राप्त करना चाहते हैं तो आपको इस बॉट के लिए प्रीमियम सदस्यता खरीदनी होगी।\n\n💵 sᴇᴇ ᴘʀᴇᴍɪᴜᴍ ᴘʟᴀɴs ➪ /plans 🎭\n💵 sᴇᴇ ᴘʀᴇᴍɪᴜᴍ ᴘʟᴀɴs ➪ /plans 🎭\n\nअन्यथा आप हमारे मुफ्त बॉट से फिल्में प्राप्त करें।\n𝗢𝘁𝗵𝗲𝗿𝘄𝗶𝘀𝗲 𝗬𝗼𝘂 𝗚𝗲𝘁 𝗠𝗼𝘃𝗶𝗲𝘀 𝗙𝗿𝗼𝗺 𝗢𝘂𝗿 𝗙𝗿𝗲𝗲 𝗕𝗼𝘁.</b>", reply_markup=InlineKeyboardMarkup([
            [InlineKeyboardButton('💵 ʙᴜʏ ᴘʀᴇᴍɪᴜᴍ: ᴠɪᴇᴡ ɪɴ ᴘᴍ 🎭', callback_data=f'premium_info')],
            [InlineKeyboardButton("♂️ ᴡᴀᴛᴄʜ ғᴏʀ ғʀᴇᴇ ♂️", url=GRP_LNK)]]))
...
async def give_filter(bot, message):
    ...
    if not is_rejected:
        ...
        if owner:
          ...
          eply_text(text=f"ᴛʜɪs ɢʀᴏᴜᴘ ɴᴏᴛ ᴠᴇʀɪғɪᴇᴅ")
